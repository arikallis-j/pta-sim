...
where $\mathcal{P}(\hat{\Omega})$ is the power spectrum on the unit sphere, and defined as:
...
$$
\mathcal{P}(\hat{\Omega}) = \exp \left[ - \frac{2 (1 - \hat{\Omega} \cdot \hat{\Omega}_0)}{2 \sigma^2} \right] = \exp \left[ - \frac{1}{\sigma^2} + \frac{\hat{\Omega} \cdot \hat{\Omega}_0 }{\sigma^2}\right] = \exp \left[ - \frac{1}{\sigma^2} \right] \cdot  \exp \left[ \frac{\hat{\Omega} \cdot \hat{\Omega}_0 }{\sigma^2}\right]
$$
...
$$
\begin{equation}
\Gamma^{(g)}(\hat{p}, \hat{q}) = \frac{3 e^{-\kappa}}{4\pi}\int_{S^2} d \hat{\Omega} \cdot \mathcal{K}(\hat{\Omega}, \hat{p}, \hat{q}) \cdot \exp \left( \kappa \hat{\Omega} \cdot \hat{\Omega}_0 \right)
\end{equation}
$$
